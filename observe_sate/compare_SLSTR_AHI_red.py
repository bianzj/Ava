...
indir_slstr_lst = r'i:\S3B_tif\\'
indir_slstr_tif = r'i:\s3b_tif\\'
indir_ahi_lst = r'i:\s3b_tif_AHI\\'
indir_base = r'I:\BASE\\'
indir_ahi_tif =r'I:\S3B_TIF_AHI'


fileNames = search_file_rej(indir_slstr_lst,['red','day'],'obliq')
...
for ktype in range(8,17):
    data_ahi = np.asarray([])
    data_slstr = np.asarray([])
    for k in range(fileNum-1):
        fileName = fileNames[k]
        # print(fileName)
        infile1 = indir_slstr_lst+fileName[:off]+'red.tif'
        infile2 = indir_slstr_lst+fileName[:off]+'red_obliq.tif'
        ...
        infile9 = indir_ahi_lst+fileName[:off]+'red.tif'
        ...
        ind1 = (lst_slstr_n<lstmax)*(lst_slstr_n>lstmin)*\
              ...
              (abs(vaa_ahi - vaa_slstr_n)<2.5)*(type == ktype)
        ...
        ind2 = (lst_slstr_o<lstmax)*(lst_slstr_o>lstmin)*\
              ...
              (abs(vaa_ahi - vaa_slstr_o)<2.5)*(type == ktype)
