...
for k in range(fileNum):
    ...
    outfile1 = wdirout + dataTime + '_bt8_o.tif'
    outfile2 = wdirout + dataTime + '_bt9_o.tif'
    # outfile3 = r'F:\heihe\heihe_' + dataTime + '_' + imageTime + '_tcw_o.tif'
    outfile4 = wdirout + dataTime + '_cloud_o.tif'
    outfile5 = wdirout + dataTime + '_vza_o.tif'
    outfile6 = wdirout + dataTime + '_sza_o.tif'
    outfile7 = wdirout + dataTime + '_psi_o.tif'
    ...
    infile = fileDir + r'\bt8_o_proj.tif'
    ...
    infile = fileDir+r'bt9_o_proj.tif'
    ...
    infile = fileDir+r'cloud_o_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    ...
    infile = fileDir+r'vza_o_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
    ...
    infile = fileDir+r'sza_o_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
    ...
    infile = fileDir+r'psi_o_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
