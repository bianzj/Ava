...
for k in range(fileNum):
    ...
    [BT8, ns, nl, nb, geog, proj] = s.getTiffData(infile3)
    [BT9, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile4)
    [tcw, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile7)
    [vza, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile9)
    [red, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile6)
    [nir, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile11)
    ...
    ind = LST < 255
    LST[ind] = 0
    outfile = outdir + fileName[:off]+'LST_o.tif'
