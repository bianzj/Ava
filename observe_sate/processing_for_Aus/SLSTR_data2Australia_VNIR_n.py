...
for k in range(80,fileNum):
    ...
    outfile1 = wdirout + dataTime + '_refl_ref_n.tif'
    outfile2 = wdirout + dataTime + '_refl_red_n.tif'
    outfile3 = wdirout + dataTime + '_refl_nir_n.tif'
    outfile4 = wdirout + dataTime + '_rad_red_n.tif'
    outfile5 = wdirout + dataTime + '_rad_nir_n.tif'
    ...
    infile = fileDir + r'\refl_ref_proj.tif'
    ...
    infile = fileDir+r'refl_red_proj.tif'
    ...
    infile = fileDir+r'refl_nir_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
    ...
    infile = fileDir+r'rad_red_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
    ...
    infile = fileDir+r'rad_nir_proj.tif'
    [data, temp1, temp2, temp3, temp4, temp5] = s.getTiffData(infile)
    temp = data[imagex, imagey]
    indnew = (temp < 500) * (temp > 0) * ind
