    ...
    if ifcoeffa == 1:
        ...
        for kl in range(nll):
            for ks in range(nss):
                ...
                a[kl,ks] = fitting_LSF(lst1,lst2,vza1,vza2)
        ...
        if iffirst == 1:
            for ksate in range(2):
                ...
                for krun in range(nb):
                    ...
                    infile_ta = indir2 + symbol + '_2019%03d' % (kday + 1) + '_day_ta.tif'
        ...
        for kl in range(nll):
            for ks in range(nss):
              ...
              #  print(np.sum(ind))
                ...
                temp = fitting_LSFRLE_ta_bk(lst1,lst2,vza1,vza2,sza1,sza2,psi1,psi2,coeffa,ta)
